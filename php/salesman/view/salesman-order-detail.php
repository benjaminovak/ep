                          ...
                          <div class="container-fluid">
                            <div class="col-lg-9 col-md-9 col-sm-9">
                                <ul class="nav navbar-nav">
                                    <li><a>Naročila:</a></li>
                                    <li class="active"><a href="<?= BASE_URL."orders" ?>">Neobdelana</a></li>
                                    ...
                                    <div class="row-fluid">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="col-lg-12 col-md-12 col-sm-12" id="products">
                                                ...
                                                <?php endif; ?>
                                                <a href="<?= BASE_URL."order/handling?id=".$order["id"] ?>"  class="btn btn-primary btn-sm btn-block">Označi kot obdelano</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
