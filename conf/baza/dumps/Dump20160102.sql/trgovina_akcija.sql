...
CREATE TABLE `akcija` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_AkcijeDnevnika_Dnevnik1_idx` (`dnevnik_id`),
  CONSTRAINT `fk_AkcijeDnevnika_Dnevnik1` FOREIGN KEY (`dnevnik_id`) REFERENCES `dnevnik` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
